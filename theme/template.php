...
<div class="super_container">
  <header class="header">
    <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
      ...
      <!-- Logo -->
<div class="logo" style="display: flex; justify-content: center; align-items: flex-start; margin-bottom:1px;">
  <a href="#">
    <img class="logo_1" style="width: 40%; height: 40%; margin-bottom:0.02px; margin-left: 220px" src="<?php echo WEB_ROOT;?>images/logo1.png" alt="">
    <img class="logo_2" src="<?php echo WEB_ROOT;?>images/logo2.png" alt="">
    <img class="logo_3" src="<?php echo WEB_ROOT;?>images/logo3.png" alt="">
  </a>
</div>
      ...
      <div class="social header_social">
        <ul class="d-flex flex-row align-items-center justify-content-start">
          ...
          <li><a href="https://www.facebook.com/profile.php?id=100093483607953&mibextid=ZbWKwL"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
...
<!--         <div class="search_button">
  ...
  <div class="logo_overlay">
    <div class="logo_overlay_content d-flex flex-column align-items-center justify-content-center">
      <div class="logo"><a href="#"><img src="<?php echo WEB_ROOT;?>images/logo3.png" alt=""></a></div>
    </div>
  </div>
    ...
    <div class="menu_container d-flex flex-column align-items-center justify-content-center">
      ...
      <div class="social menu_social">
        <ul class="d-flex flex-row align-items-center justify-content-start">
          ...
          <li><a href="https://www.youtube.com/watch?v=b70uw0XxeLg"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
          <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
  ...
  <div class="home">
    <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="<?php echo WEB_ROOT;?>images/homepageimage.jpg" data-speed="0.8"></div>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Address:</div>
                    <div>Ella Echo Lodge, Kalawana, Sinharaja, Sri lanka</div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-lg-start align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Mail:</div>
                    <div>ellaecholodge@gmail.com</div>
                  </div>
                </div>
              </div>
            </div>
