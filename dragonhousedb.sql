...
(1, 'Welcome to Ella eco lodge', '5page-img1.png', 'In our Hotel', 'Located on the forest of Nice, a short distance from the famous Sinharaja forest, Ella eco is one of the hotels in the kalawana (or Blue Coast) able to satisfy the different needs of its guests with comfort and first rate services. The hotel  a real luxury in a lodge like Nice.');
...
(17, 1, 12, 'Dulax single bed', 'without TV', 2, 80, 'rooms/202305111648_ellaroom.jpg', 1, 0),
(18, 1, 12, 'Dulux double bed', 'Without TV', 4, 80, 'rooms/202305111728_dualbed.jpg', 1, 0),
(19, 1, 13, 'Traveller dulux rooms', 'Without TV', 2, 50, 'rooms/202305111737_deluxe-double.jpg', 1, 0),
(20, 2, 13, 'Casual traveler double', 'Without TV', 4, 40, 'rooms/202305111743_casual-travelr-double.jpg', 1, 0);
...
(1, 'Sinharaja road,Kudawa Delgoda kalawana, 70450 kalawana', 'ellaecholodge@gmail.com', '(+94718795047');
